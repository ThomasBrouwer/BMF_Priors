...
''' Plot settings. '''
MSE_min, MSE_max = 675, 1200
fractions_unknown = [0.3, 0.4, 0.5, 0.6, 0.7, 0.8, 0.9]
fraction_min, fraction_max = 0.38, 0.92

folder_plots = "./"
folder_results = "./../results/"
plot_file = folder_plots+"sparsity_gdsc_multiple_2rows.png"
...
fig.subplots_adjust(left=0.07, right=0.995, bottom=0.01, top=0.93, wspace=0.05)
...
ax1.set_title("(a) All methods", fontsize=8)
ax2.set_title("(b) GGG, GGGU", fontsize=8)
ax3.set_title("(c) GGG, GLL, GEE, GTT, GL21", fontsize=8)
ax4.set_title("(d) GLL, GLLI, GTT, GTTN, PGG, PGGG", fontsize=8)
ax5.set_title("(e) GGG, GVG, GEG, GVnG", fontsize=8)
