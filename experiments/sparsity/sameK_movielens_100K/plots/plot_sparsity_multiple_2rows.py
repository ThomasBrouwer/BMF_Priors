...
fraction_min, fraction_max = 0.928, 0.982
fractions_unknown = [0.93, 0.94, 0.95, 0.96, 0.97, 0.98]

folder_plots = "./"
folder_results = "./../results/"
plot_file = folder_plots+"sparsity_movielens_100k_multiple_2rows.png"
...
ax2.set_title("(l) GGG, GGGU", fontsize=8)
ax3.set_title("(m) GGG, GLL, GEE, GTT, GL21", fontsize=8)
