'''
Methods for creating the noisy versions of the methylation GM dataset, and
...
FOLDER_FILES = project_location+'BMF_Priors/experiments/noise/methylation_gm/data/'
