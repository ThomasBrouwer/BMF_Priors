...
name_kernelU_kernelV = [
    ...
    ('glli',   numpy.mean([construct_kernel(glli_U[i])   for i in range(10)], axis=0), 
               numpy.mean([construct_kernel(glli_V[i])   for i in range(10)], axis=0)), 
    ...
    ('gl21',   numpy.mean([construct_kernel(gl21_U[i])   for i in range(10)], axis=0), 
               numpy.mean([construct_kernel(gl21_V[i])   for i in range(10)], axis=0)), 
