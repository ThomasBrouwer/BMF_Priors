...
- Compute a Gaussian similarity kernel (row-wise similarity) for U and V.
- Plot these kernels.
- Also compute the average of the non-diagonal values of these kernels.
"""
...
name_plotname_kernelU_kernelV = [
    (name, filename, numpy.loadtxt(folder_kernels+'%s_%s_U.txt' % (kernel_type, filename)), 
                     numpy.loadtxt(folder_kernels+'%s_%s_V.txt' % (kernel_type, filename)))
...
folder_plots_kernels = './plots_kernels/'
plot = True
