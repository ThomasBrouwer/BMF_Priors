...
ml100k_gll = eval(open(folder_results+'performances_gaussian_laplace.txt','r').read())
ml100k_glli = eval(open(folder_results+'performances_gaussian_laplace_ig.txt','r').read())
