...
''' Plot settings. '''
MSE_min, MSE_max = 665, 800
values_K = [1,2,3,4,6,8,10,15,20,30]

folder_plots = "./"
folder_results = "./../results/"
plot_file = folder_plots+"model_selection_gdsc_multiple_2rows.png"
...
ax2.set_title("(b) GGG, GGGW, GGGA, GLL", fontsize=8)
ax3.set_title("(c) GEE, GEEA, GL21", fontsize=8)
